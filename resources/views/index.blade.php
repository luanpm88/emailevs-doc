...
<head>
  ...
  <meta name="twitter:site" content="@{{ trans('messages.app_sdk_name') }}">
...
<body class="index" data-languages="[&quot;shell&quot;,&quot;ruby&quot;,&quot;javascript&quot;,&quot;python&quot;]">
  ...
  <div class="toc-wrapper"> <a href="https://{{ trans('messages.app_domain') }}"><img src="{{ env('APP_LOGO') }}" class="logo"
        data-at2x="images/{{ trans('messages.app_sdk_name') }}-logo--main.png" data-rjs="2" alt="" data-rjs-processed="true"></a>
  ...
  <div class="page-wrapper">
    ...
    <div class="content">
      ...
      <pre class="highlight javascript tab-javascript" style="display: block;"><code><span class="kd">var</span> <span class="nx">{{ trans('messages.app_sdk_name') }}</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s2">"{{ trans('messages.app_sdk_name') }}"</span><span class="p">)(</span><span class="s2">"your_api_key"</span><span class="p">);</span>
    </code></pre>
      <pre class="highlight python tab-python" style="display: none;"><code><span class="n">client</span> <span class="o">=</span> <span class="n">{{ trans('messages.app_sdk_name') }}</span><span class="o">.</span><span class="n">Client</span><span class="p">(</span><span class="s">'your_api_key'</span><span class="p">)</span>
    </code></pre>
      <blockquote>
      ...
      <pre class="highlight ruby tab-ruby" style="display: none;"><code><span class="n">gem</span> <span class="n">install</span> <span class="n">{{ trans('messages.app_sdk_name') }}</span>
    </code></pre>
      <pre class="highlight javascript tab-javascript" style="display: block;"><code><span class="nx">npm</span> <span class="nx">install</span> <span class="nx">{{ trans('messages.app_sdk_name') }}</span> <span class="o">--</span><span class="nx">save</span>
    <span class="err">#</span> <span class="nx">or</span>
    <span class="nx">yarn</span> <span class="nx">add</span> <span class="nx">{{ trans('messages.app_sdk_name') }}</span>
    </code></pre>
      <pre class="highlight python tab-python" style="display: none;"><code><span class="n">pip</span> <span class="n">install</span> <span class="n">{{ trans('messages.app_sdk_name') }}</span>
    </code></pre>
      ...
      <pre class="highlight javascript tab-javascript" style="display: block;"><code><span class="nx">{{ trans('messages.app_sdk_name') }}</span><span class="p">.</span><span class="nx">verify</span><span class="p">(</span><span class="s1">'john@smith.com'</span><span class="p">)</span>
    ...
    <span class="nx">{{ trans('messages.app_sdk_name') }}</span><span class="p">.</span><span class="nx">batches</span><span class="p">.</span><span class="nx">verify</span><span class="p">(</span><span class="nx">emails</span><span class="p">)</span>
      <span class="p">.</span><span class="nx">then</span><span class="p">(</span><span class="kd">function</span> <span class="p">(</span><span class="nx">response</span><span class="p">)</span> <span class="p">{</span>
        <span class="c1">// asynchronously called</span>
      <span class="p">});</span>
    </code></pre>
    ...
    <span class="nx">{{ trans('messages.app_sdk_name') }}</span><span class="p">.</span><span class="nx">batches</span><span class="p">.</span><span class="nx">status</span><span class="p">(</span><span class="nx">id</span><span class="p">)</span>
      <span class="p">.</span><span class="nx">then</span><span class="p">(</span><span class="kd">function</span> <span class="p">(</span><span class="nx">response</span><span class="p">)</span> <span class="p">{</span>
        <span class="c1">// asynchronously called</span>
      <span class="p">});</span>
    </code></pre>
      ...
      </span><span class="s2">"download_file"</span><span class="p">:</span><span class="w"> </span><span class="s2">"https://app.{{ trans('messages.app_sdk_name') }}-cdn.com/downloads/6284ee8ee1b8323ee12c201c/5cf6dd30093f96d2ac34bb0a.csv?X-Amz-Expires=3600&amp;X-Amz-Date=20220518T130252Z&amp;X-Amz-Algorithm=AWS4-HMAC-SHA256&amp;X-Amz-Credential=AKIA5FIXD2WWI62KKBML/20220518/us-east-1/s3/aws4_request&amp;X-Amz-SignedHeaders=host&amp;X-Amz-Signature=7e38682a949082d7cc7e8e2bdc09973e0fdedd858de23061447af1a32ee65779"</span><span class="p">,</span><span class="w">
      </span><span class="s2">"message"</span><span class="p">:</span><span class="w"> </span><span class="s2">"Batch verification completed."</span><span class="p">,</span><span class="w">
      </span><span class="s2">"reason_counts"</span><span class="p">:</span><span class="w"> </span><span class="p">{</span><span class="w">
      ...
      <pre class="highlight javascript tab-javascript" style="display: block;"><code><span class="nx">{{ trans('messages.app_sdk_name') }}</span><span class="p">.</span><span class="nx">account</span><span class="p">()</span>
      <span class="p">.</span><span class="nx">then</span><span class="p">(</span><span class="kd">function</span> <span class="p">(</span><span class="nx">response</span><span class="p">)</span> <span class="p">{</span>
        <span class="c1">// asynchronously called</span>
      <span class="p">});</span>
    </code></pre>
      ...
      <span class="p">})(</span><span class="nb">window</span><span class="p">,</span> <span class="nb">document</span><span class="p">,</span> <span class="s1">'{{ trans('messages.app_sdk_name') }}'</span><span class="p">);</span>
    
      <span class="nx">{{ trans('messages.app_sdk_name') }}</span><span class="p">(</span><span class="s1">'apiKey'</span><span class="p">,</span> <span class="s1">'your_api_key'</span><span class="p">);</span>
    <span class="nt">&lt;/script&gt;</span>
      ...
      <span class="nx">{{ trans('messages.app_sdk_name') }}</span><span class="p">(</span><span class="s1">'allow'</span><span class="p">,</span> <span class="p">{</span>
      ...
      <span class="nx">{{ trans('messages.app_sdk_name') }}</span><span class="p">(</span><span class="s1">'verificationTimeout'</span><span class="p">,</span> <span class="mi">5</span><span class="p">);</span>
    
      <span class="c1">// how long to wait after a user stops typing to verify the email</span>
      <span class="nx">{{ trans('messages.app_sdk_name') }}</span><span class="p">(</span><span class="s1">'verifyAfterDelay'</span><span class="p">,</span> <span class="mi">1000</span><span class="p">);</span>
      ...
      <span class="nx">{{ trans('messages.app_sdk_name') }}</span><span class="p">(</span><span class="s1">'formValidation'</span><span class="p">,</span> <span class="kc">true</span><span class="p">);</span>
    
      <span class="c1">// this is the selector for the inputs we will monitor</span>
      <span class="nx">{{ trans('messages.app_sdk_name') }}</span><span class="p">(</span><span class="s1">'inputSelector'</span><span class="p">,</span> <span class="s1">'input[type=email]'</span><span class="p">);</span>
    
      <span class="c1">// array of form names to ignore</span>
      <span class="nx">{{ trans('messages.app_sdk_name') }}</span><span class="p">(</span><span class="s1">'ignoredForms'</span><span class="p">,</span> <span class="p">[]);</span>
    
      <span class="c1">// array of input names to ignore</span>
      <span class="nx">{{ trans('messages.app_sdk_name') }}</span><span class="p">(</span><span class="s1">'ignoredInputs'</span><span class="p">,</span> <span class="p">[]);</span>
      ...
      <span class="nx">{{ trans('messages.app_sdk_name') }}</span><span class="p">(</span><span class="s1">'blockOnRateLimit'</span><span class="p">,</span> <span class="kc">false</span><span class="p">)</span>
      ...
      <span class="nx">{{ trans('messages.app_sdk_name') }}</span><span class="p">(</span><span class="s1">'statusAppendTo'</span><span class="p">,</span> <span class="s1">'body'</span><span class="p">)</span>
    
      <span class="c1">// styles</span>
      <span class="nx">{{ trans('messages.app_sdk_name') }}</span><span class="p">(</span><span class="s1">'style'</span><span class="p">,</span> <span class="p">{</span>
        <span class="na">loadingIconColor</span><span class="p">:</span> <span class="s1">'rgba(0, 0, 0, 0.3)'</span>
      <span class="p">});</span>
    
      <span class="c1">// messages</span>
      <span class="nx">{{ trans('messages.app_sdk_name') }}</span><span class="p">(</span><span class="s1">'messages'</span><span class="p">,</span> <span class="p">{</span>
